    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                 ...
                 <ul class="social">
                     <li>
                        <a href="https://www.facebook.com/andi.hoerudin.5" target="_blank"><i class="fab fa-facebook-f"></i></a>
                     </li>
                     <li>
                        <a href="https://www.instagram.com/andi_hoerudin/" target="_blank"><i class="fab fa-instagram"></i></a>
                     </li>
                     <li>
                        <a href="https://www.youtube.com/channel/UCpU7qfVvHlMf698on43t9LQ/playlists?view_as=subscriber" target="_blank"><i class="fab fa-youtube"></i></a>
                     </li>
                 </ul>
            </div>
            <div class="col-md-3">
